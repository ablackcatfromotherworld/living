...
session = tls_client.Session(client_identifier="chrome_103", random_tls_extension_order=True)
res = session.get('https://www.cxtv.com.br/data/tv_cat_list_load.php', params=params)
print(res.text)